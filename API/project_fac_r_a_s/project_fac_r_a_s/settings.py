"""
Django settings for project_fac_r_a_s project.
...
SECRET_KEY = 'e0!qiikv$_9*2(!58x&cgwbwra8(751^#&b^ef1p*fj(4=(s+5'
...
ROOT_URLCONF = 'project_fac_r_a_s.urls'
...
WSGI_APPLICATION = 'project_fac_r_a_s.wsgi.application'
...
TIME_ZONE = tz[tz.index("Asia/Kolkata")]
